...
/// Create listing screen — multi-step wizard.
...
class _CreateListingScreenState extends ConsumerState<CreateListingScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // Invalidate my listings cache
      ref.invalidate(myListingsProvider);

      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(context.l10n.createPublishSuccess),
                    ...
                    child: Row(
                      children: [
                        FilledButton(
                          ...
                          child: Text(
                            _currentStep < 2 ? l.createNext : l.createPublish,
                          ),
                        ),
                        ...
                        TextButton(
                          ...
                          child: Text(
                            _currentStep > 0 ? l.createBack : l.createCancel,
                          ),
                        ),
                      ],
                    ),
                      ...
                      children: [
                          ...
                          data: (categories) =>
                            ...
                            items: categories
                                .map((c) => DropdownMenuItem(
                                      value: c.value,
                                      child: Text(AppLocale.isArabic(Localizations.localeOf(context)) ? c.labelAr : c.labelEn),
                                    ))
                                .toList(),
                            onChanged: (v) =>
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          items: [
                            ...
                            DropdownMenuItem(
                                value: 'LIKE_NEW', child: Text(l.condLikeNew)),
                            DropdownMenuItem(
